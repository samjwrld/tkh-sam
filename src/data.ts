...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    year: '2025',
    desc: 'An exquisite study in light wood accents, generous negative spaces, and hidden custom storage. This residence provides a serene escape from the high-octane life of Hyderabad’s Financial District, incorporating cozy family seating and kid-friendly play layouts without disrupting the peaceful minimalist visual stream.',
